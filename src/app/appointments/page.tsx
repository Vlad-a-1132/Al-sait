...
export const metadata = {
  title: 'Запись на прием к врачу онлайн - Медицинский центр Альтамед-С в Одинцово',
  description: 'Запись на прием к врачу онлайн в медицинском центре Альтамед-С в Одинцово. Выберите врача, дату и время, заполните форму записи. Быстро, удобно, без очередей.',
  keywords: [
  ...
  openGraph: {
    title: 'Запись на прием к врачу онлайн - Медицинский центр Альтамед-С в Одинцово',
    description: 'Запись на прием к врачу онлайн в медицинском центре Альтамед-С в Одинцово. Выберите врача, дату и время, заполните форму записи.',

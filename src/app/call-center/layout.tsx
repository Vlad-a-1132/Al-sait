...
export const metadata: Metadata = {
  title: 'Колл-центр - Медицинский центр Альтамед-Св Одинцово | Запись по телефону',
  description: 'Колл-центр медицинского центра Альтамед-Св Одинцово - запись на прием по телефону, консультации, справки о записях. Запись на прием: +7 (495) 255-44-50',
  keywords: [

...
export const metadata: Metadata = {
  ...
  description: "Медицинский центр Альтамед-Св Одинцово - многопрофильная клиника с широким спектром медицинских услуг. Запись к врачу онлайн, современное оборудование, опытные специалисты. Терапия, педиатрия, гинекология, стоматология, диагностика и многое другое.",
  keywords: [

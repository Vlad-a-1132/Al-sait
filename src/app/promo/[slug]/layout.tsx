...
const promotionsData: Record<string, {
  ...
  'promo-2': {
    ...
    description: 'Комплексное УЗИ для женщин в Одинцово - УЗИ органов малого таза + молочных желез + щитовидной железы за 5200 ₽. Экономия 1000 рублей.',
  ...
  'promo-5': {
    ...
    description: 'При первичном приеме врача акушера-гинеколога в Одинцово - кольпоскопия в подарок в клинике Альтамед-с.',

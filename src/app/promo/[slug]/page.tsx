...
export default function PromoDetailPage() {
  ...
  const promotions = [
    ...
    },
    {
      ...
      fullDescription: "Комплексное ультразвуковое исследование для женщин включает три важнейших обследования за одну процедуру. Экономия 1000 рублей!",
      details: [
        ...
        "Экономия 1000 рублей по сравнению с раздельными обследованиями"
      ]
    },
    {
      id: 3,

...
function SearchContent() {
  ...
  const sitePages = [
    ...
    { title: 'Гинекология', url: '/ginekolog-v-odintsovo', description: 'Женское здоровье и репродуктивная медицина', keywords: ['гинекология', 'гинеколог', 'женское здоровье', 'гинеколог-сексолог'] },

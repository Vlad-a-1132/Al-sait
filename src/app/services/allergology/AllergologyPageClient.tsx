...
export default function AllergologyPageClient({ serviceRows }: Props) {
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1 min-w-0 pr-2">
                          ...
                          <div className="text-emerald-600 font-semibold text-lg break-words">{service.priceLabel}</div>
                        </div>
                        <Link
                          href="https://online.altamed-c.ru/"
                          target="_blank"

...
export default function AllergologyPage() {
  ...
  // Данные услуг аллергологии
  const allergologyServices = [
    { id: 1, code: "B01.002.001", name: "Прием (осмотр, консультация) врача-аллерголога-иммунолога первичный", price: "4 100 руб.", image: "/images/yslugi/allergoly.webp", description: "Первичная консультация и осмотр у врача-аллерголога-иммунолога" },
    { id: 2, code: "B01.002.002", name: "Прием (осмотр, консультация) врача-аллерголога-иммунолога повторный", price: "3 150 руб.", image: "/images/yslugi/allergoly.webp", description: "Повторная консультация у врача-аллерголога-иммунолога" },
    { id: 3, code: "B04.002.002", name: "Профилактический прием (осмотр, консультация) врача-аллерголога иммунолога", price: "3 150 руб.", image: "/images/yslugi/allergoly.webp", description: "Профилактический осмотр у врача-аллерголога-иммунолога" },
    { id: 4, code: "B03.002.004", name: "Комплекс исследований для выявления аллергена", price: "Цена по запросу", image: "/images/yslugi/allergoly.webp", description: "Комплексное аллергологическое обследование для выявления аллергенов" },
    { id: 5, code: "B03.037.001", name: "Функциональное тестирование легких", price: "2 100 руб.", image: "/images/yslugi/allergoly.webp", description: "Исследование функции внешнего дыхания" },
    { id: 6, code: "B04.002.001", name: "Диспансерный прием (осмотр, консультация) врача-аллерголога-иммунолога", price: "3 150 руб.", image: "/images/yslugi/allergoly.webp", description: "Диспансерное наблюдение у врача-аллерголога-иммунолога" },
    { id: 7, code: "A12.06.006", name: "Накожные исследования реакции на аллергены", price: "950 руб.", image: "/images/yslugi/allergoly.webp", description: "Кожные пробы для выявления аллергенов" },
    { id: 8, code: "A12.09.001", name: "Исследование неспровоцированных дыхательных объемов и потоков", price: "1 580 руб.", image: "/images/yslugi/allergoly.webp", description: "Спирометрия без применения лекарственных препаратов" },
    { id: 9, code: "A12.09.002.001", name: "Исследование дыхательных объемов с применением лекарственных препаратов", price: "2 210 руб.", image: "/images/yslugi/allergoly.webp", description: "Спирометрия с бронхолитическими препаратами" },
    { id: 10, code: "A12.09.002.002", name: "Исследование дыхательных объемов при провокации физической нагрузкой", price: "2 210 руб.", image: "/images/yslugi/allergoly.webp", description: "Спирометрия с физической нагрузкой" },
  ];
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {allergologyServices.map((service, index) => (
                    <div 
                      key={service.id}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Специалист по аллергологии - это медицинский эксперт, который занимается выявлением, предупреждением и терапией различных форм аллергических патологий. 
                В клинике «Альтамед-с» консультируют высококвалифицированные аллергологи с многолетним стажем работы и глубокими знаниями в области иммунологии. 
                ...
                <div className="px-6 pb-6" itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div className="space-y-4 text-gray-700" itemProp="text">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">Кожное аллергологическое тестирование методом прик-теста</h4>
                        <p>
                          В ходе данного исследования кожа пациента аккуратно прокалывается специальным прик-ланцетом через каплю раствора определенного аллергена на глубину не более 1 мм. 
                          Результаты тестирования позволяют специалисту-аллергологу уже через 15-20 минут точно идентифицировать аллергенное вещество, спровоцировавшее развитие заболевания, 
                          а также оценить уровень чувствительности организма к различным группам аллергенов.
                        </p>
                      </div>
                      
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">Определение общих и специфических иммуноглобулинов Е (Ig E) в сыворотке крови</h4>
                        <p>
                          Данная методика предусматривает измерение концентрации иммуноглобулина Е (IgE) в крови пациента, повышенные показатели которого указывают на активную выработку 
                          специфических антител организмом. Этот диагностический подход позволяет специалисту проанализировать кровь на наличие реакции более чем к 100 различным аллергенам.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          Исследование направлено на выявление причинно-следственной связи между аллергическими реакциями и приемом фармацевтических препаратов. 
                          В процессе диагностики оценивается индивидуальная переносимость наиболее распространенных и жизненно важных медикаментов: антибиотических средств, 
                          обезболивающих и противовоспалительных препаратов, антикоагулянтов.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          Данная процедура позволяет диагностировать наличие и степень выраженности бронхообструкции (нарушение дыхательной функции) при бронхиальной астме 
                          или обструктивном бронхите, что является важным для определения тактики лечения.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 text-gray-700" itemProp="text">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p>
                            Заключается в минимизации воздействия причиннозначимых аллергенов на организм пациента. 
                            В «Альтамед-с» применяются наиболее эффективные способы элиминации, включая подбор индивидуальной гипоаллергенной диеты 
                            и обучение пациента принципам гипоаллергенного образа жизни.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p>
                            Проводится в «Альтамед-с» с использованием современных высокоэффективных антигистаминных препаратов 
                            и других медикаментов местного и системного действия, подбираемых индивидуально для каждого пациента.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p>
                            Подразумевает введение в организм сверхмалых доз причиннозначимых аллергенов в виде подкожных инъекций 
                            или подъязычных капель, что позволяет снизить чувствительность организма к аллергенам.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p>
                            Включают ингаляционную терапию для купирования обострений бронхиальной астмы и электрофорез 
                            (метод электролечения, при котором лекарственные вещества направленно поступают в организм под действием слабых импульсов электрического тока). 
                    ...
                    <div className="mt-6 p-4 bg-emerald-50 rounded-lg border-l-4 border-emerald-500">
                      <p className="text-gray-700">
                        Записаться на прием аллерголога в «Альтамед-с» можно, позвонив по телефону в Одинцово +7 (495) 255-44-50 
                        или заполнив форму обратной связи на нашем сайте. Наши врачи работают в будние, выходные и праздничные дни. 
                        Кроме этого, вы можете вызвать аллерголога на дом в удобное для вас время.
                      </p>
                    </div>
                  </div>
                </div>

...
export default function CardiologyPageClient({ serviceRows }: Props) {
      ...
      <section className="py-4">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">Кардиология</span>
          </nav>
        </div>
      </section>
        ...
        <section className="py-16" aria-labelledby="services-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">Полный спектр услуг кардиологии</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  ...
                  В клинике «Альтамед-с» в Одинцово консультируют высококвалифицированные кардиологи с многолетним стажем работы и глубокими знаниями в
                  области сердечно-сосудистых заболеваний. Среди наших специалистов работают врачи высшей категории, кандидаты и доктора медицинских наук,
                  активно участвующие в научно-исследовательской деятельности. Для получения качественной кардиологической помощи в Одинцово и Московской
                  области рекомендуем обратиться именно в «Альтамед-с».
                </p>
                <p className="text-lg text-gray-600 mb-6">
                  Консультация кардиолога в Одинцово требуется при появлении болей в области сердца, одышки, перебоев в работе сердца, повышении
                  артериального давления или других симптомов сердечно-сосудистых заболеваний. Сердечные заболевания требуют профессионального подхода,
                  поэтому самостоятельная диагностика крайне нежелательна. Наиболее эффективным решением станет обращение к опытному кардиологу в
                  «Альтамед-с» в Одинцово. Наши специалисты проведут комплексное обследование, включая ЭКГ, холтер, эхокардиографию, лабораторные анализы,
                  установят точный диагноз, разработают индивидуальную схему терапии и дадут рекомендации по поддержанию здоровья сердца.
                </p>
              </div>
              <div className="relative">
                <img src="/images/images allergoly/kardiolog.webp" alt="Кардиология" className="w-full h-auto rounded-full shadow-lg" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700">боли в области сердца;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">одышка при физической нагрузке;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">перебои в работе сердца;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">учащенное сердцебиение;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">повышенное артериальное давление;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">головокружения и обмороки;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">отеки ног;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">быстрая утомляемость;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">потливость;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">боли в груди при нагрузке;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                <span className="text-gray-700">нарушения сна;</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0"></div>
                  ...
                  <div className="px-6 pb-6" itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                    <div className="space-y-4 text-gray-700" itemProp="text">
                      ...
                      <div className="space-y-4">
                        <div>
                          <h4 className="font-semibold text-gray-800 mb-2">Электрокардиография (ЭКГ)</h4>
                          <p>
                            Запись электрической активности сердца для выявления нарушений ритма, ишемии, инфаркта миокарда.
                          </p>
                        </div>
                        
                        <div>
                          <h4 className="font-semibold text-gray-800 mb-2">Холтеровское мониторирование</h4>
                          <p>
                            Суточная запись ЭКГ для выявления скрытых нарушений ритма и ишемии миокарда.
                          </p>
                        </div>
                        
                        <div>
                          <h4 className="font-semibold text-gray-800 mb-2">Эхокардиография</h4>
                          <p>
                            Ультразвуковое исследование сердца для оценки его структуры и функции.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p>
                            Анализы крови на маркеры инфаркта миокарда, липидный профиль, показатели воспаления.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p>
                              Назначение современных препаратов для лечения гипертонии, аритмии, ишемической болезни сердца.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-semibold text-gray-800 mb-1">Коррекция образа жизни</h4>
                            <p>
                              Рекомендации по диете, физическим нагрузкам, отказу от вредных привычек.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-semibold text-gray-800 mb-1">Профилактика осложнений</h4>
                            <p>
                              Предотвращение инфаркта миокарда, инсульта, сердечной недостаточности.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4 text-gray-700" itemProp="text">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-semibold text-gray-800 mb-1">Регулярные обследования</h4>
                            <p>
                              Плановые осмотры кардиолога, контроль артериального давления, анализы крови.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p>
                              Правильное питание, регулярные физические нагрузки, отказ от курения и алкоголя.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
                          <div>
                            <h4 className="font-semibold text-gray-800 mb-1">Контроль факторов риска</h4>
                            <p>
                              Поддержание нормального веса, контроль уровня холестерина и сахара в крови.
                            </p>
                          </div>
                        </div>
                      </div>

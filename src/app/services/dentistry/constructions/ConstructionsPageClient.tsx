...
export type DentistryConstructionsServiceRow = {
  key: string;
  code: string | null;
  name: string;
  priceLabel: string;
...
export type DentistryConstructionsPriceSectionUi = {
  sectionKey: string;
  title: string;
  rows: DentistryConstructionsServiceRow[];
};

type Props = {
  priceSections: DentistryConstructionsPriceSectionUi[];
};

function normalizePriceForUi(s: DentistryConstructionsServiceRow): string {
...
export default function ConstructionsPageClient({ priceSections }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
      ...
      <section className="py-12 bg-gray-50" aria-labelledby="dentistry-constructions-prices-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-[20px] shadow-lg p-6 md:p-10">
            <h2 id="dentistry-constructions-prices-heading" className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 text-center">

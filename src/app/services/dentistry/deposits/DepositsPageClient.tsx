...
export type DentistryDepositsServiceRow = {
  key: string;
  code: string | null;
  name: string;
  priceLabel: string;
...
export type DentistryDepositsPriceSectionUi = {
  sectionKey: string;
  title: string;
  rows: DentistryDepositsServiceRow[];
};

type Props = {
  priceSections: DentistryDepositsPriceSectionUi[];
};

function normalizePriceForUi(s: DentistryDepositsServiceRow): string {
...
export default function DepositsPageClient({ priceSections }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Удаление зубных отложений в клинике «Альтамед-с»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Ультразвуковое удаление зубного камня и снятие налета методом Air Flow в Одинцово
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Удаление зубных отложений в Одинцово: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед-С» предлагает услуги удаления зубных отложений в Одинцово — ультразвуковое
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость удаления зубных отложений в Одинцово
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Преимущества удаления отложений в «Альтамед-С»</h2>
      ...
      <section className="py-12 bg-gray-50" aria-labelledby="dentistry-deposits-prices-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-[20px] shadow-lg p-6 md:p-10">
            <h2 id="dentistry-deposits-prices-heading" className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 text-center">
              Услуги удаления зубных отложений в Одинцово
            </h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Удаление зубных отложений в Одинцово: цены и отзывы пациентов
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed text-sm md:text-base mb-6">
            <p>
              Стоматология «Альтамед-С» — клиника, где удаление зубных отложений в Одинцове проводится
            ...
            <p>
              ...
              где «удаление зубных отложений одинцово» — это не просто слоган, а качественная услуга, записывайтесь
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов об удалении зубных отложений в Одинцово
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                После удаления отложений в Одинцове пациенты отмечают отсутствие дискомфорта; врачи дают
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы об удалении зубных отложений в Одинцово
          </h2>
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Удаление зубных отложений в Одинцово — начните с консультации
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на процедуру в клинику «Альтамед-С», чтобы удалить зубной камень и налет,
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед-С» — удаление зубных отложений в Одинцово",
                url: "https://altamed-c.ru/services/dentistry/deposits",
                image: "https://altamed-c.ru/images/dentisrty/task_01kb5h4ze2ek2vjpgzt0wnmcvh_1764343713_img_0.webp",
                ...
                description:
                  "Удаление зубных отложений в Одинцово: ультразвуковое удаление камня, Air Flow для снятия налета, эффективная очистка зубов.",
                sameAs: [
                  "https://altamed-c.ru",

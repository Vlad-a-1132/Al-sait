...
import type {
  DentistryExtractionPriceSectionUi,
  DentistryExtractionServiceRow,
} from "../extraction/ExtractionPageClient";

type Props = {
  priceSections: DentistryExtractionPriceSectionUi[];
};

function normalizePriceForUi(s: DentistryExtractionServiceRow): string {
...
export default function EmergencyPageClient({ priceSections }: Props) {
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Экстренная хирургия в клинике «Альтамед-с»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Хирургическая обработка ран, вскрытие абсцессов и лечение альвеолита в Одинцово
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Экстренная хирургия в Одинцово: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед-С» предлагает услуги экстренной хирургии в Одинцово — хирургическую обработку ран,
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость экстренной хирургии в Одинцово
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Преимущества экстренной хирургии в «Альтамед-С»</h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Экстренная хирургия в Одинцово: цены и отзывы пациентов
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed text-sm md:text-base mb-6">
            <p>
              Стоматология «Альтамед-С» — клиника, где экстренная хирургия в Одинцове проводится по международным
            ...
            <p>
              ...
              где «экстренная хирургия одинцово» — это не просто слоган, а качественная услуга, записывайтесь
      ...
      <section className="py-12 bg-gray-50" aria-labelledby="dentistry-emergency-prices-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-[20px] shadow-lg p-6 md:p-10">
            <h2 id="dentistry-emergency-prices-heading" className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 text-center">
              Цены на экстренную хирургию в Одинцово
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов об экстренной хирургии в Одинцово
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                После экстренной помощи в Одинцове пациенты отмечают быстрое улучшение состояния; врачи дают
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы об экстренной хирургии в Одинцово
          </h2>
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Экстренная хирургия в Одинцово — получите помощь быстро
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на экстренный прием в клинику «Альтамед-С», чтобы получить помощь при острых состояниях,
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед-С» — экстренная хирургия в Одинцово",
                ...
                description:
                  "Экстренная хирургия в Одинцово: хирургическая обработка ран, вскрытие абсцессов, лечение альвеолита и других неотложных состояний.",
                sameAs: [
                  "https://altamed-c.ru",

...
export type DentistryOrthodonticMaintenanceServiceRow = {
  key: string;
  code: string | null;
  name: string;
  priceLabel: string;
...
export type DentistryOrthodonticMaintenancePriceSectionUi = {
  sectionKey: string;
  title: string;
  rows: DentistryOrthodonticMaintenanceServiceRow[];
};

type Props = {
  priceSections: DentistryOrthodonticMaintenancePriceSectionUi[];
};

function normalizePriceForUi(s: DentistryOrthodonticMaintenanceServiceRow): string {
...
export default function OrthodonticMaintenancePageClient({ priceSections }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Обслуживание ортодонтических аппаратов в клинике «Альтамед-с»
              </h1>
              <p className="text-lg md:text-xl mb-8 text-emerald-100">
                Ремонт, замена дуг и лигатур, активация брекет-систем в Одинцово
              </p>
            </div>
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5 text-gray-700 leading-relaxed">
              <h2 className="text-3xl font-bold text-gray-900">Обслуживание ортодонтических аппаратов в Одинцово: почему выбирают нас</h2>
              <p>
                Клиника «Альтамед-С» предлагает услуги по обслуживанию ортодонтических аппаратов в Одинцово — ремонт,
              ...
              <p>
                Прозрачные цены позволяют планировать бюджет — стоимость обслуживания ортодонтических аппаратов в Одинцово
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Преимущества обслуживания аппаратов в «Альтамед-С»</h2>
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Обслуживание ортодонтических аппаратов в Одинцово: цены и отзывы пациентов
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed text-sm md:text-base mb-6">
            <p>
              Стоматология «Альтамед-С» — клиника, где обслуживание ортодонтических аппаратов в Одинцове проводится
            ...
            <p>
              ...
              где «обслуживание ортодонтических аппаратов одинцово» — это не просто слоган, а качественная услуга, записывайтесь
      ...
      <section className="py-12 bg-gray-50" aria-labelledby="dentistry-orthodontic-maintenance-prices-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-[20px] shadow-lg p-6 md:p-10">
            <h2
              id="dentistry-orthodontic-maintenance-prices-heading"
              className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 text-center"
            >
              Цены на обслуживание ортодонтических аппаратов в Одинцово
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Отзывы пациентов об обслуживании ортодонтических аппаратов в Одинцово
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                После обслуживания аппаратов в Одинцове пациенты отмечают комфорт; врачи дают
      ...
      <section className="py-12 bg-white">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Частые вопросы об обслуживании ортодонтических аппаратов в Одинцово
          </h2>
          ...
          <div className="bg-gradient-to-r from-[#4A5568] to-[#5A6474] rounded-[20px] p-8 md:p-12 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Обслуживание ортодонтических аппаратов в Одинцово — получите качественное обслуживание
              </h2>
              <p className="text-white/90 text-sm md:text-base leading-relaxed">
                Запишитесь на обслуживание в клинику «Альтамед-С», чтобы получить качественное обслуживание
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                name: "Клиника «Альтамед-С» — обслуживание ортодонтических аппаратов в Одинцово",
                ...
                description:
                  "Обслуживание ортодонтических аппаратов в Одинцово: ремонт, замена дуг и лигатур, активация брекет-систем и другие процедуры обслуживания.",
                sameAs: [
                  "https://altamed-c.ru",

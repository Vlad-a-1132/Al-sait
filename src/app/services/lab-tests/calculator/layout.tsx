...
export const metadata: Metadata = {
  ...
  description: 'Калькулятор анализов - рассчитайте стоимость лабораторных анализов онлайн. Выберите нужные анализы и узнайте общую стоимость. Удобный инструмент для планирования обследования в медицинском центре Альтамед-Св Одинцово.',
  keywords: [

...
export default function MammologyPageClientV2({ serviceRows }: Props) {
  ...
  return (
    <div className="mammology-v2">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-lg text-gray-700 mb-5 sm:mb-7 max-w-xl">
                Принимаем с профилактическими вопросами и симптомами: боль, уплотнения, выделения, изменения кожи и формы. На приёме врач оценит жалобы,
                назначит нужные обследования и объяснит план действий.
              </p>
      ...
      <style jsx global>{`
        .mammology-v2 > div > section.py-4 {
          display: none !important;
        }
        .mammology-v2 > div > main.py-3 {
          display: none !important;
        }
      `}</style>

      <MammologyPageClient serviceRows={serviceRows} />
    </div>
  );
}

...
/** Блок «Почему Альтамед-С» — в V2 над секцией врачей */
export function OphthalmologyWhyAltamedSection() {
  return (
    <section className="py-12 bg-gray-50" aria-labelledby="ophthalmology-why-altamed">
      <div className="mx-auto px-4" style={{ maxWidth: "83rem" }}>
        <h2 id="ophthalmology-why-altamed" className="text-3xl font-bold text-gray-900 text-center mb-12">
          Почему «Альтамед-С»?
        </h2>
...
/** Прайс + сайдбар записи — используется и в V2 сразу после блока врачей */
export function OphthalmologyPriceAndBookingSection({ serviceRows }: Props) {
  return (
    <section className="py-16 bg-gray-50" aria-labelledby="services-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 id="services-heading" className="text-2xl md:text-3xl font-bold text-black mb-8 text-center ml-0 md:ml-4 lg:ml-8">
          Офтальмолог в Одинцово — услуги диагностики и лечения заболеваний глаз
        </h2>
...
export default function OphthalmologyPageClient({ serviceRows }: Props) {
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Консультация офтальмолога в Одинцово — профессиональная диагностика заболеваний глаз
                </h2>
                <p className="text-lg text-gray-600 mb-6">
                  В клинике «Альтамед-с» в Одинцово проводят осмотр и консультации врачи-офтальмологи: подбор коррекции зрения, диагностика воспалительных
                  и возрастных изменений, контроль при хронических заболеваниях — с акцентом на понятный план действий для пациента.
                </p>
              </div>
      ...
      <section className="py-8 bg-amber-50 border-y border-amber-100" aria-labelledby="ophthalmology-dilation-notice">
        <div className="mx-auto px-4 max-w-4xl">
          <h2 id="ophthalmology-dilation-notice" className="text-lg sm:text-xl font-bold text-amber-950 mb-3 flex items-center gap-2">
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-amber-200/80 text-amber-950 text-lg" aria-hidden>
              !
            </span>
            Важно знать перед осмотром глазного дна
          </h2>
          <p className="text-amber-950/90 text-sm sm:text-base leading-relaxed">
            Для оценки сетчатки врач может использовать капли, расширяющие зрачок. После такого осмотра зрение вблизи может временно стать мутным, а глаза —
            более чувствительными к свету. National Eye Institute и Mayo Clinic также отмечают, что после расширения зрачка несколько часов может сохраняться
            размытость зрения и светочувствительность, поэтому лучше заранее продумать дорогу домой и не планировать вождение до восстановления комфорта.
          </p>
        </div>
      </section>

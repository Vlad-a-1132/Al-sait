    ...
    <div className="flex flex-col bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="w-full md:w-1/2 text-gray-700 space-y-4">
              ...
              <p>
                В медицинском центре Альтамед-Св Одинцово опытные врачи-остеопаты помогают восстановить баланс организма и справиться с функциональными нарушениями. Организм человека — это уникальная саморегулирующаяся система, способная поддерживать здоровье и противостоять болезням. Однако современные факторы окружающей среды часто нарушают этот баланс, приводя к различным патологическим состояниям.
              </p>
              <p>
                Остеопаты центра Альтамед-Св Одинцово направляют свои усилия на поиск истинных причин нарушений и восстановление естественного равновесия в организме пациента.
              </p>
              <p>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Основная концепция остеопатии — организм это единое целое, где структура и функция взаимосвязаны. Специалисты медицинского центра Альтамед-Св Одинцово подходят к лечению комплексно, учитывая все аспекты здоровья пациента.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            По данным ведущих мировых специалистов, в Западной Европе 70% населения с функциональными нарушениями обращаются именно к остеопату. Медицинский центр Альтамед-Св Одинцово предлагает современный подход к диагностике и лечению без медикаментов.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            При функциональных нарушениях классическое обследование часто не выявляет патологий, хотя пациент страдает от болей в спине, головной боли, болезненных менструаций и других симптомов. В таких случаях назначают медикаменты, но жалобы остаются. Остеопатия помогает найти истинную причину проблемы. Важно понимать, что нелеченные функциональные нарушения со временем переходят в органические. Поэтому остеопатия является эффективной профилактической медициной в центре Альтамед-Св Одинцово.
          </p>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Остеопатическое лечение в медицинском центре Альтамед-Св Одинцово направлено на восстановление ограниченной подвижности. В отличие от мануальной терапии, которая фокусируется на локальных проблемах, остеопат проводит комплексный осмотр всего тела, чтобы выявить первопричину заболевания.
          </p>
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            На консультации в медицинском центре Альтамед-Св Одинцово врач-остеопат проводит комплексную мануальную диагностику, коррекцию позвоночника, краниальную терапию, висцеральную мануальную терапию и мышечную релаксацию при следующих заболеваниях:
          </p>

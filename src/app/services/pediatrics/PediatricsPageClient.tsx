...
export type PediatricsServiceRow = {
  key: string;
  code: string | null;
  name: string;
  priceLabel: string;
...
function normalizePriceForUi(s: PediatricsServiceRow): string {
...
export default function PediatricsPageClient({ serviceRows }: Props) {
    ...
    <div className="flex flex-col min-h-full bg-white mx-auto">
            ...
            <div className="block md:hidden w-full h-[300px] flex flex-col rounded-[20px] overflow-hidden shadow-md mx-auto">
              <div className="h-[220px] bg-emerald-500 relative overflow-hidden">
                <div className="w-full h-full relative">
                  <img src="/images/yslugi/Pediatrician.webp" alt="Педиатрия в Одинцово" className="w-full h-full object-cover" />
                </div>
              </div>
              {/* Нижняя часть */}
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="md:hidden space-y-6">
            <div className="flex items-start gap-4">
              ...
              <p className="text-gray-700 font-medium text-left pt-2">Опытные врачи-педиатры с многолетним стажем работы</p>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 flex-shrink-0 relative">
              ...
              <p className="text-gray-700 font-medium text-left pt-2">
                Индивидуальный подход к каждому ребенку с учетом возраста и особенностей
              </p>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 flex-shrink-0 relative">
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-gray-700 font-medium text-left pt-2">
                Комфортные условия для детей и родителей, доброжелательная атмосфера
              </p>
            </div>
          </div>
          <div className="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-700 font-medium">Опытные врачи-педиатры с многолетним стажем работы</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 relative">
                <img src="/images/yslugi/star 1.webp" alt="2" className="w-full h-full object-contain" />
              ...
              <p className="text-gray-700 font-medium">Индивидуальный подход к каждому ребенку с учетом возраста и особенностей</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 relative">
                <img src="/images/yslugi/star 1.webp" alt="3" className="w-full h-full object-contain" />
              ...
              <p className="text-gray-700 font-medium">Современная диагностика и лечение в соответствии с клиническими рекомендациями</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 relative">
                <img src="/images/yslugi/star 1.webp" alt="4" className="w-full h-full object-contain" />
              ...
              <p className="text-gray-700 font-medium">Комфортные условия для детей и родителей, доброжелательная атмосфера</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="flex-1">
        ...
        <section className="py-16 bg-white" aria-labelledby="what-we-treat-heading">
          <div className="max-w-6xl mx-auto px-8">
            ...
            <div className="space-y-6 text-gray-700 mb-8">
              <p>
                Врачи-педиатры клиники «Альтамед-С» в Одинцово занимаются диагностикой и лечением широкого спектра заболеваний у детей. Мы
                оказываем квалифицированную медицинскую помощь детям всех возрастов, используя современные методы диагностики и лечения в
                соответствии с международными клиническими рекомендациями.
              </p>
            </div>

            {/* Alphabetical list of conditions */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {pediatricConditions.map((group) => (
        ...
        <section className="py-16 bg-gray-50">
          <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Консультация детского педиатра в Одинцово</h2>
                <p className="text-lg text-gray-600 mb-6">
                  Педиатр — это врач, специализирующийся на диагностике, лечении и профилактике заболеваний у детей от рождения до 18 лет. В
                  клинике «Альтамед-С» в Одинцово работают опытные врачи-педиатры, которые с вниманием и заботой относятся к каждому ребенку.
                </p>
                <p className="text-lg text-gray-600 mb-6">
                  Регулярные профилактические осмотры у педиатра помогают вовремя выявить проблемы со здоровьем, провести вакцинацию, получить
                  рекомендации по питанию и режиму дня. Мы создаем комфортные условия для детей и их родителей, обеспечивая качественное
        ...
        <section className="py-16 bg-white">
          <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Педиатрическая помощь детям разных возрастов</h2>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">Ответы на популярные вопросы о педиатрии</p>
            </div>

            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <button
                  onClick={() => toggleExpanded('when')}
                ...
                >
                  ...
                  <svg
                    className={`w-6 h-6 transform transition-transform duration-300 ${expandedItems['when'] ? 'rotate-180' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                {expandedItems['when'] && (
                  <div className="px-6 py-4 bg-white">
                    <p className="text-gray-600">
                      Педиатр нужен при любых признаках заболевания у ребёнка (температура, кашель, боль, высыпания), а также для плановых
                      профилактических осмотров и вакцинации.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <button
                  ...
                  className="w-full px-6 py-4 text-left bg-gradient-to-r from-emerald-600 to-emerald-700 text-white hover:from-emerald-700 hover:to-emerald-800 transition-colors duration-300 flex justify-between items-center"
                >
                  <h3 className="text-xl font-semibold">Зачем нужна вакцинация</h3>
                  <svg
                ...
                {expandedItems['vaccination'] && (
                  <div className="px-6 py-4 bg-white">
                    <p className="text-gray-600">
                      Вакцинация помогает сформировать иммунитет к опасным инфекциям и снижает риск тяжёлого течения заболеваний.
                    </p>
                  </div>
                )}
              </div>

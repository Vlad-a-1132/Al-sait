...
export function PediatricsWhyAltamedSection() {
  return (
...
export function PediatricsPricesSection({ serviceRows }: { serviceRows: PediatricsServiceRow[] }) {
  return (
    <section className="py-12 md:py-16 bg-white scroll-mt-20" aria-labelledby="services-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 id="services-heading" className="text-2xl md:text-3xl font-bold text-black mb-8 text-center ml-0 md:ml-4 lg:ml-8">
          Педиатр в Одинцово — услуги наблюдения и лечения детей
        </h2>
...
export default function PediatricsPageClient() {
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
      {/* Breadcrumb — скрыт в V2 через CSS */}
      ...
      {/* Main section — скрыт в V2 через CSS */}
      <main className="py-3">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Консультация детского педиатра в Одинцово — профессиональная помощь детям и родителям
                </h2>
                <p className="text-lg text-gray-600 mb-6">
                  В клинике «Альтамед-с» в Одинцово работают врачи-педиатры, которые ведут приём детей разных возрастов: от плановых осмотров до острых
                  состояний, с понятными рекомендациями для семьи.
                </p>
              </div>

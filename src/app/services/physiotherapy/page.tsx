    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            В медицинском центре Альтамед-Св Одинцово применяются разнообразные методы физиотерапии:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 text-base md:text-lg mb-4 ml-4">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            С учётом индивидуальных и возрастных особенностей, переносимости физических факторов, наличия сопутствующих заболеваний, и при отсутствии противопоказаний физиотерапевт медицинского центра Альтамед-Св Одинцово назначит вам эффективное лечение.
          </p>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg mb-4">
            Уникальная система для низкоинтенсивной магнитотерапии BEMER из Германии применяется в медицинском центре Альтамед-Св Одинцово.
          </p>

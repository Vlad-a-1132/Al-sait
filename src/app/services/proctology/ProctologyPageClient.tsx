...
export default function ProctologyPageClient({ serviceRows }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          ...
          <div className="mb-8">
            ...
            <div className="hidden md:block h-[445px] bg-emerald-500 relative overflow-hidden rounded-[20px] shadow-lg">
              <div className="w-full h-full relative">
                <img src="/images/images allergoly/proktolog.webp" alt="Проктология в Одинцово" className="w-full h-full object-cover" />
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-start p-8 md:p-12 text-black">
                ...
                <p className="text-lg md:text-xl mb-6 max-w-md">
                  Профессиональная диагностика и лечение заболеваний прямой кишки
                </p>
                <Link
                  href="https://online.altamed-c.ru/"
                  target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Полный спектр диагностических и лечебных процедур в колопроктологии
            </p>
          ...
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            <div className="lg:col-span-2 order-2 lg:order-1 rounded-2xl border border-gray-200 overflow-hidden bg-white">
              ...
              <div className="overflow-y-auto max-h-[520px] sm:max-h-[560px]">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {proctologyConditions.map((group) => (
      ...
      {/* FAQ (оставляем механизм раскрытия) */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Часто задаваемые вопросы</h2>
            <p className="text-lg text-gray-600">Ответы на популярные вопросы о колопроктологии</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              >
                <h3 className="text-xl font-semibold">Когда нужно обращаться к колопроктологу</h3>
                <svg
              ...
              {expandedItems['when'] && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-600">
                    Обратитесь к врачу при боли, крови, дискомфорте, зуде, изменении стула, выпадении узлов или других симптомах со стороны
                    прямой кишки. Также показаны профилактические осмотры при факторах риска.
                  </p>
                </div>
              )}
            </div>

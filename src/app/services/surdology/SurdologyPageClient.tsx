...
export type SurdologyServiceRow = {
  key: string;
  code: string | null;
  name: string;
  priceLabel: string;
...
type Props = {
  serviceRows: SurdologyServiceRow[];
};

function normalizePriceForUi(s: SurdologyServiceRow): string {
...
export default function SurdologyPageClient({ serviceRows }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white mx-auto">
        ...
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <header className="mb-6 ml-0 md:ml-4 lg:ml-8">
            ...
            <p className="text-gray-600 mt-2 px-4 md:px-0 text-sm md:text-base">
              Диагностика и лечение заболеваний органов слуха в Одинцово
            </p>
          </header>
          ...
          <div className="mb-8">
            ...
            <div className="hidden md:block h-[445px] bg-emerald-500 relative overflow-hidden rounded-[20px] shadow-lg">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-start p-8 md:p-12 text-black">
                <h2 className="text-2xl md:text-4xl font-bold mb-4">Сурдология в Одинцово</h2>
                <p className="text-lg md:text-xl mb-6 max-w-md">Современная диагностика и лечение нарушений слуха</p>
                <Link
                  href="https://online.altamed-c.ru/"
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      {/* Services Section — заменяем на Полный прайс */}
      <section className="py-16" aria-labelledby="services-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 id="services-heading" className="text-3xl font-bold text-gray-900 mb-4">
              Услуги сурдолога и ЛОР-врача
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Диагностика и лечение заболеваний уха, горла и носа. Полный прайс — ниже.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Заболевания по алфавиту</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {surdologyConditions.map((group) => (
      ...
      {/* FAQ (оставляем механизм раскрытия, чтобы страница не обеднела) */}
      <section className="py-16 bg-gray-50">
        <div className="mx-auto px-4" style={{ maxWidth: '83rem' }}>
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Часто задаваемые вопросы</h2>
            <p className="text-lg text-gray-600">Ответы на популярные вопросы о сурдологии</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              >
                <h3 className="text-xl font-semibold">Когда стоит обратиться к сурдологу</h3>
                <svg
              ...
              {expandedItems['when'] && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-600">
                    Если вы заметили снижение слуха, шум/звон в ушах, заложенность, головокружение или ухудшение разборчивости речи —
                    лучше пройти диагностику. Также полезны профилактические проверки слуха.
                  </p>
                </div>
              )}
            </div>

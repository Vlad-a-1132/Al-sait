...
export const doctors = [
  ...
  { id: 2, name: "Балян Мария Маисовна", slug: "balyan-maria-maisovna", specialization: "Отоларинголог, Сурдолог", experience: 15, photo: "/images/doctors/Vector 16.svg", description: "Врач-оториноларинголог, сурдолог. Врач высшей квалификационной категории" },
  ...
  { id: 53, name: "Исаева Екатерина Николаевна", slug: "isaeva-ekaterina-nikolaevna", specialization: "Гигиенист стоматологический, Стоматология профилактическая", experience: 6, photo: "/images/promo/task_01kmc5pqv4egd8vgfksjjp1zzd_1774230180_img_1.webp", description: "Квалифицированный гигиенист в области профилактики заболеваний полости рта и поддержания здоровья зубов и десен. Профессиональная гигиена, подбор средств ухода. Стаж с 2019 года." }
];
